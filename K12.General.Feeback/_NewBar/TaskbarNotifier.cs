...
namespace K12.General.Feedback
{
    ...
    public class TaskbarNotifier : System.Windows.Forms.Form
    {
        ...
        protected Timer timer_run = new Timer();
        protected TaskbarStates taskbarState = TaskbarStates.hidden;
        protected string titleText;
        protected string BackTitleText;
        protected string contentText;
        protected Color normalTitleColor = Color.FromArgb(255, 255, 255);
        protected Color hoverTitleColor = Color.FromArgb(255, 255, 255);
        protected Color normalContentColor = Color.FromArgb(255, 255, 255);
        protected Color hoverContentColor = Color.FromArgb(255, 255, 255);
        protected Font normalTitleFont = new Font("Arial", 30, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font hoverTitleFont = new Font("Arial", 30, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font normalContentFont = new Font("Arial", 35, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font hoverContentFont = new Font("Arial", 35, FontStyle.Bold, GraphicsUnit.Pixel);
        ...
        public TaskbarNotifier()
        {
            ...
            timer_run.Tick += new EventHandler(OnTimer_Run);
        }
        ...
        public void Show(string strTitle, string strContent, int nTimeToShow, int nTimeToStay, int nTimeToHide)
        {
            ...
            titleText = strTitle;
            BackTitleText = titleText;
            contentText = strContent;
            nVisibleEvents = nTimeToStay;

            TimerCountEnd = nTimeToStay / 1000; //結束時間
            ...
            switch (taskbarState)
            {
                ...
                case TaskbarStates.appearing: //顯示
                    Refresh();
                    break;

                case TaskbarStates.visible: //可見
                    timer.Stop();
                ...
                case TaskbarStates.disappearing: //消失
                    timer.Stop();
                    timer_run.Stop();
        ...
        int TimerCountEnd { get; set; }
        protected void OnTimer_Run(Object obj, EventArgs ea)
        {
            if (TimerCountEnd > 0)
            {
                TimerCountEnd = TimerCountEnd - 1;
                titleText = BackTitleText + "(" + TimerCountEnd + ")";
